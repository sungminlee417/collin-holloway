      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="lg:flex lg:gap-16 xl:gap-24">
          ...
          <div className="lg:w-1/2">
            <div className="sticky top-5 aspect-[4/5] overflow-hidden">
              <Image
                src={aboutData.image}
          ...
          <motion.div
            ...
            className="space-y-12 lg:space-y-16 lg:w-1/2 mt-16 lg:mt-0 lg:min-h-[150vh]"
          >
            ...
            >
              ...
              <i
                className={`fas fa-chevron-${
                  isExpanded ? "up" : "down"
                } text-xs transition-transform group-hover:translate-y-0.5`}
              ></i>
            </button>
            ...
            <div className="grid gap-12 mt-16 lg:mt-20">
              ...
              >
                <h4 className="font-serif text-lg font-medium text-slate-900 dark:text-white tracking-wide italic">
                  Education
                </h4>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed tracking-wide">
                  Eastman School of Music, University of Kentucky, Private study
                  in Italy with Angelo Gilardino
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed tracking-wide">
                  Haire Guitar Competition Winner, National Brownsville Duet
                  Competition, Rising Young Artist
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed tracking-wide">
                  Austin City Limits, CHAMBERart Madrid, Los Romeros Quartet
                  collaboration
                </p>
              </motion.div>

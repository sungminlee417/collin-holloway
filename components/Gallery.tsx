...
export default function Gallery() {
  ...
  return (
    <>
      <section id="gallery" className="py-16 sm:py-24 lg:py-32 px-6 sm:px-8 md:px-12 lg:px-16 xl:px-24 2xl:px-32 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 lg:mb-8 tracking-tight text-slate-900">Gallery</h2>
